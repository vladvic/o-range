...
public:
    ...
    void onNewSession(resip::ServerInviteSessionHandle, resip::InviteSession::OfferAnswerType oat, const resip::SipMessage& msg) override;

    void onNewSession(resip::ClientInviteSessionHandle, resip::InviteSession::OfferAnswerType oat, const resip::SipMessage& msg) override {}
    ...
    void onEarlyMedia(resip::ClientInviteSessionHandle, const resip::SipMessage&, const resip::Contents&) override {}
    void onProvisional(resip::ClientInviteSessionHandle, const resip::SipMessage&) override {}
    ...
    void onTerminated(resip::InviteSessionHandle, InviteSessionHandler::TerminatedReason reason, const resip::SipMessage* related=0) override {}
    ...
    void onAnswer(resip::InviteSessionHandle, const resip::SipMessage& msg, const resip::SdpContents&) override {}
    void onOffer(resip::InviteSessionHandle, const resip::SipMessage& msg, const resip::SdpContents&) override {}
    void onOfferRequired(resip::InviteSessionHandle, const resip::SipMessage& msg) override {}
    void onOfferRejected(resip::InviteSessionHandle, const resip::SipMessage* msg) override {}
